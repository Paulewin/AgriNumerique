...
knitr::include_graphics("D:/projet_sda/ProjetSDA/logo.jpg")
```
...
Le tableau A1 présente le profil socio-économique et le système de production des agriculteurs enquêtés.
 Les communes les plus représentées sont Misserete (40 %), Dogbo (22 %) et Parakou (16 % ). La majorité des participants sont des hommes (77 %), contre (23 %) de femmes.
```{r, include=FALSE}
library(dplyr)
library(gtsummary)
library(knitr)
...
simulation %>%
select(sexe, age, etude, commune, type_agri, culture1) %>%
...
knitr::include_graphics("D:/projet_sda/ProjetSDA/Graphe A1.png")
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("D:/projet_sda/ProjetSDA/Graphe A2.png")
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("D:/projet_sda/ProjetSDA/Graphe A3 bon.png")
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("D:/projet_sda/ProjetSDA/Graphe B2.png")
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("D:/projet_sda/ProjetSDA/Graphe B3.png")
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("D:/projet_sda/ProjetSDA/Graphe B4.png")
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("D:/projet_sda/ProjetSDA/Graphe B5.png")
...
Les résultats montrent que 94% des producteurs possèdent un téléphone. Mais malgré la disponibilité de l'outil, seuls 35% d'entre eux ont accès àinternet (Tableau C1).
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("D:/projet_sda/ProjetSDA/Graphe C1.png")

knitr::include_graphics("D:/projet_sda/ProjetSDA/GrapheCAP C2.PNG")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("D:/projet_sda/ProjetSDA/Graphe C3.png")
...
```{r, echo=FALSE}
knitr::include_graphics("D:/projet_sda/ProjetSDA/GrapheCAP C4.PNG")
...
```{r, echo=FALSE}
knitr::include_graphics("D:/projet_sda/ProjetSDA/GrapheCAP C5.PNG")
